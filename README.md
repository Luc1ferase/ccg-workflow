...
[![npm version](https://img.shields.io/npm/v/%40luc1ferase%2Fccg-workflow.svg)](https://www.npmjs.com/package/@luc1ferase/ccg-workflow)
...
安装后本地 CLI 命令仍然是 `ccg`，只是 npm 包名改为 `@luc1ferase/ccg-workflow`。
...
[![Star History Chart](https://api.star-history.com/svg?repos=Luc1ferase/ccg-workflow&type=timeline&legend=top-left)](https://www.star-history.com/#Luc1ferase/ccg-workflow&type=timeline&legend=top-left)
...
v1.7.65 | [Issues](https://github.com/Luc1ferase/ccg-workflow/issues)
